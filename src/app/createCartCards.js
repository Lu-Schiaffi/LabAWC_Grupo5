            ...
            <div class="col-9 col-sm-10">
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <div class="d-flex align-items-center">
                        <button type="button" class="btn btn-outline-dark text-bg-secondary btn-sm me-2" id="buttonLess-${product.id}-cart">-</button>
                        <span class="fw-bold me-2">Cantidad: ${product.quantity}</span>
                        <button type="button" class="btn btn-outline-dark text-bg-secondary btn-sm me-3" id="buttonAdd-${product.id}-cart">+</button>
                        <button type="button" class="btn btn-outline-dark text-bg-secondary btn-sm" id="buttonDelete-${product.id}-cart">
